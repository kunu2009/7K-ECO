...
export const studyMaterials: Record<number, StudyMaterials> = {
    ...
    8: {
        ...
        flashcards: [
            ...
            { term:g: "Finance Commission", definition: "A constitutional body in India that determines the method and formula for distributing the tax proceeds between the Centre and states." },
        ],
        mcqs: [
    ...
    9: {
        ...
        flashcards: [
            ...
            { term:_prompt: "Mobilization of Savings", definition: "A key function of the capital market, channeling savings from households to productive investments." },
        ...
        mcqs: [
            ...
            { term: "Nifty 50 is the benchmark index of which stock exchange?", options: ["BSE", "NSE", "Calcutta Stock Exchange", "NASDAQ"], answer: "NSE" },
            { term: "Commercial Papers are issued by:", options: ["The Government", "Large Corporations", "The RBI", "Small businesses"], answer: "Large Corporations" },
            { term: "The market where existing securities are traded is called the:", options: ["Primary Market", "Money Market", "Secondary Market", "Forex Market"], answer: "Secondary Market" },
            { term: "Which market primarily provides long-term funds for investment?", options: ["Call Money Market", "Money Market", "Capital Market", "Commodity Market"], answer: "Capital Market" },
            { term: "A key function of the money market is to provide:", options: ["Long-term capital", "Liquidity", "Ownership in companies", "Foreign exchange"], answer: "Liquidity" },
            { term: "Shares and bonds are instruments of the:", options: ["Money Market", "Capital Market", "Real Estate Market", "Unorganized sector"], answer: "Capital Market" },
            { term: "A Demat account is used to:", options: ["Hold cash", "Hold physical shares", "Hold securities in electronic form", "Trade commodities"], answer: "Hold securities in electronic form" },
        ]
    },
    10: {
